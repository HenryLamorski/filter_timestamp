...
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['tofield']['1']        = 'Zeige Frontend-Feld für Wert 1.';
...
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['lessequal']['0']      = 'Operator >= bzw. <= anstatt < > verwenden.';
$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['moreequal']['0']      = 'Operator >= bzw. <= anstatt < > verwenden.';

$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['typenames']['timestamp'] = 'Datum Filter';

$GLOBALS['TL_LANG']['tl_metamodel_filtersetting']['mode']['0']		= 'Betriebsart';
